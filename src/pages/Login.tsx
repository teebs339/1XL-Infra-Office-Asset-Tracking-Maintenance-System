      ...
      <div className="hidden lg:flex lg:w-[55%] relative items-center justify-center p-16">
        <div className="max-w-xl">
          <div className="flex items-center gap-4 mb-10">
            <img src={`${import.meta.env.BASE_URL}logo.jpg`} alt="1XL" className="w-14 h-14 rounded-2xl object-contain" />
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-8 sm:p-12 relative">
        <div className="w-full max-w-[520px]">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10 justify-center">
            <img src={`${import.meta.env.BASE_URL}logo.jpg`} alt="1XL" className="w-12 h-12 rounded-xl object-contain" />
